...
public class WS_Called_Token_NoProgress {
    ...
    public WS_Called_Token_NoProgress(Context context, String strURL, Map<String, String> params, int resultCode, int methodUsed) {
